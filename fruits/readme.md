...
Une fois le travail récupérer, veiller bien à lancer la commande :
```bash
tp3$  npm install
```
...
tp3$  npm run build 
```
Afin de produire le bundle. Il suffira de lancer le fichier Index.html pour pouvoir tester le jeu

### Travail réalisé

Tout a été réaliser et fonctionne.